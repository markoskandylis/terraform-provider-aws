...
description: |-
  Terraform data source for managing an AWS Managed Streaming for Kafka Vpc Connection.
---
<!---
...
# Data Source: aws_kafka_vpc_connection
...
```terraform
data "aws_kafka_vpc_connection" "example" {
}
```
